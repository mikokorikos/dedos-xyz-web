    ...
    >
      ...
      <header className="plan-header">
        <div className="plan-headline">
          <span className={`plan-icon ${plan.tone}`}>{PLAN_ICONS[plan.icon]}</span>
          <div className="plan-intro">
            <div className="chips" role="list">
              ...
              {plan.highlight ? (
                <span className={`chip ${plan.highlight.tone}`} role="listitem">
      ...
      {plan.cta ? (
        <a className="btn btn-gradient plan-cta" href={plan.cta.href} target="_blank" rel="noopener noreferrer">
          {plan.cta.label}
        </a>
      ) : null}
    </article>
